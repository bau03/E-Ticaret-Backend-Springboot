...
public class ProductService {
    ...
    public void productSave( AddProductForm addProductForm)  {
        ...
        Product product = new Product(
                ...
                addProductForm.getExplanation(),
                Float.parseFloat(addProductForm.getPrice()),
                parseInt(addProductForm.getStock()));
/*        File convertFile = new File("/var/tmp/"+addProductForm.getProductImage());
        ...
        Category categories = categoryRepository.findByCategorys(Categorys.valueOf(addProductForm.getProductCategory().toString()))
                .orElseThrow(() -> new RuntimeException("Fail! -> Cause: Product category not found."));
    ...
    public List<Product> getProduct(){
        return productRepository.findAllByEnabled(false);
    }
