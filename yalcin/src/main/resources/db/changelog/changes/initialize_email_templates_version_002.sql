...
<table align="center" border="0" cellpadding="0" cellspacing="0" width="600" style="border-collapse: collapse;">
    <tr>
        <td bgcolor="#eaeaea" style="padding: 40px 30px 40px 30px;">
            ...
            <p>  <span th:text="${productName}"></span> isimli ürününüz  <span th:text="${name}"></span> kullanıcısı tarafından sipariş edilmiştir. Sistem üzerinden ürünü onaylayınız.</b></p>
        </td>
    </tr>
    <tr>
        <td bgcolor="#777777" style="padding: 30px 30px 30px 30px;">
...
insert into email_templates (template_name, content)
VALUES ('db-seller-product_email',
'<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html lang="en" xmlns:th="https://thymeleaf.org">
<head>
    <title>Sending Email with Thymeleaf HTML Template Example</title>
...
<table align="center" border="0" cellpadding="0" cellspacing="0" width="600" style="border-collapse: collapse;">
    <tr>
        <td bgcolor="#eaeaea" style="padding: 40px 30px 40px 30px;">
            <p >Dear <span th:text="${username}"></span>,</p>
            <p>  <span th:text="${productName}"></span> isimli ürününüz  <span th:text="${name}"></span> satıcısı tarafından onaylanmıştır.</b></p>
        </td>
    </tr>
    <tr>
        <td bgcolor="#777777" style="padding: 30px 30px 30px 30px;">
